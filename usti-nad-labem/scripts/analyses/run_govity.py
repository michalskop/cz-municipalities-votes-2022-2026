"""Run the govity analysis for Zastupitelstvo města Ústí nad Labem.
...
`usti-nad-labem/analyses/govity/govity_definition.json`. PENDING PROJECT OWNER SIGN-OFF (D7) as of this
...
Usage:
  python usti-nad-labem/scripts/analyses/run_govity.py --script /path/to/legislature-data-analyses/govity/govity.py
"""
