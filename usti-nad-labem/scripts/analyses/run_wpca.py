"""Run the wpca analysis for Zastupitelstvo města Ústí nad Labem.

Invokes the shared, unmodified `wpca.py` from the separate `legislature-data-analyses` repository.
City-specific content is entirely in `usti-nad-labem/analyses/wpca/wpca_definition.json`. Its
...
Usage:
  python usti-nad-labem/scripts/analyses/run_wpca.py --script /path/to/legislature-data-analyses/wpca/wpca.py
"""
