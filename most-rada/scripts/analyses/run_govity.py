"""Run the govity analysis for Rada města Mostu.
...
`most-rada/analyses/govity/govity_definition.json`. PENDING PROJECT OWNER SIGN-OFF (D7) as of this
...
Usage:
  python most-rada/scripts/analyses/run_govity.py --script /path/to/legislature-data-analyses/govity/govity.py
"""
