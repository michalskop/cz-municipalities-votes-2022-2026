"""Build an all-members.dt.analyses-shaped JSON from Most's standard tables.
...
Most's `most/scripts/party_affiliation.py` populates real, live `classification: "group"`
...
Output is NOT committed (most/work/ is gitignored) — regenerate on demand before running an
