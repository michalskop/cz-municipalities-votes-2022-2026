"""Build an all-members.dt.analyses-shaped JSON from Zastupitelstvo města Hradec Králové's standard tables.
...
Zastupitelstvo města Hradec Králové's `hradec-kralove/scripts/party_affiliation.py` populates real,
...
Output is NOT committed (hradec-kralove/work/ is gitignored) — regenerate on demand before running an
