"""Run the wpca analysis for Zastupitelstvo města Hradec Králové.

Invokes the shared, unmodified `wpca.py` from the separate `legislature-data-analyses` repository.
City-specific content is entirely in `hradec-kralove/analyses/wpca/wpca_definition.json`. Its
...
Usage:
  python hradec-kralove/scripts/analyses/run_wpca.py --script /path/to/legislature-data-analyses/wpca/wpca.py
"""
