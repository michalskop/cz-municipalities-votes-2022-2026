"""Run the govity analysis for Zastupitelstvo města Hradec Králové.
...
`hradec-kralove/analyses/govity/govity_definition.json`. PENDING PROJECT OWNER SIGN-OFF (D7) as of this
...
Usage:
  python hradec-kralove/scripts/analyses/run_govity.py --script /path/to/legislature-data-analyses/govity/govity.py
"""
