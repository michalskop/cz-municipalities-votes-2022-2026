"""Run the govity analysis for Ostrava.
...
`ostrava/analyses/govity/govity_definition.json`. PENDING PROJECT OWNER SIGN-OFF (D7) as of this
...
Usage:
  python ostrava/scripts/analyses/run_govity.py --script /path/to/legislature-data-analyses/govity/govity.py
"""
