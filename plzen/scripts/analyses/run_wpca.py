"""Run the wpca analysis for Plzeň.

Invokes the shared, unmodified `wpca.py` from the separate `legislature-data-analyses` repository.
City-specific content is entirely in `plzen/analyses/wpca/wpca_definition.json`. Its
...
Usage:
  python plzen/scripts/analyses/run_wpca.py --script /path/to/legislature-data-analyses/wpca/wpca.py
"""
