"""Run the govity analysis for Plzeň.
...
`plzen/analyses/govity/govity_definition.json`. PENDING PROJECT OWNER SIGN-OFF (D7) as of this
...
Usage:
  python plzen/scripts/analyses/run_govity.py --script /path/to/legislature-data-analyses/govity/govity.py
"""
