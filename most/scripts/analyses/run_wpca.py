"""Run the wpca analysis for Most.

Invokes the shared, unmodified `wpca.py` from the separate `legislature-data-analyses` repository.
City-specific content is entirely in `most/analyses/wpca/wpca_definition.json`. Its
...
Usage:
  python most/scripts/analyses/run_wpca.py --script /path/to/legislature-data-analyses/wpca/wpca.py
"""
