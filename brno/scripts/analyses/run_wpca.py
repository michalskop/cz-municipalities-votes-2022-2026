"""Run the wpca analysis for Brno.

Invokes the shared, unmodified `wpca.py` from the separate `legislature-data-analyses` repository.
City-specific content is entirely in `brno/analyses/wpca/wpca_definition.json`, owner-approved
2026-08-27 (D7, inherited from govity's government_groups sign-off).
...
Usage:
  python brno/scripts/analyses/run_wpca.py --script /path/to/legislature-data-analyses/wpca/wpca.py
"""
