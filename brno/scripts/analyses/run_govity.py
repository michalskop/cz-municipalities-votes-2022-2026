"""Run the govity analysis for Brno.
...
`brno/analyses/govity/govity_definition.json`, owner-approved 2026-08-27 (D7).

Usage:
  python brno/scripts/analyses/run_govity.py --script /path/to/legislature-data-analyses/govity/govity.py
"""
