"""Run the wpca analysis for Zastupitelstvo statutárního města České Budějovice.

Invokes the shared, unmodified `wpca.py` from the separate `legislature-data-analyses` repository.
City-specific content is entirely in `ceske-budejovice/analyses/wpca/wpca_definition.json`. Its
...
Usage:
  python ceske-budejovice/scripts/analyses/run_wpca.py --script /path/to/legislature-data-analyses/wpca/wpca.py
"""
