"""Run the govity analysis for Zastupitelstvo statutárního města České Budějovice.
...
`ceske-budejovice/analyses/govity/govity_definition.json`. PENDING PROJECT OWNER SIGN-OFF (D7) as of this
...
Usage:
  python ceske-budejovice/scripts/analyses/run_govity.py --script /path/to/legislature-data-analyses/govity/govity.py
"""
