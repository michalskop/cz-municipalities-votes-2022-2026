"""Build an all-members.dt.analyses-shaped JSON from Zastupitelstvo města Pardubice's standard tables.
...
Zastupitelstvo města Pardubice's `pardubice/scripts/party_affiliation.py` populates real,
...
Output is NOT committed (pardubice/work/ is gitignored) — regenerate on demand before running an
